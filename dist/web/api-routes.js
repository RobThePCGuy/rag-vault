...
import { getFeedbackStore } from '../flywheel/index.js';
 ...
 */
export function createApiRouter(serverOrAccessor) {
    ...
    router.post('/files/upload', asyncHandler(async (req, res) => {
    ...
    router.get('/documents/chunks', asyncHandler(async (req, res) => {
    ...
    router.get('/chunks/related', asyncHandler(async (req, res) => {
        const filePath = req.query['filePath'];
        ...
        if (includeExplanation) {
            ...
            const dataWithExplanation = data.map((chunk) => ({
                ...chunk,
                explanation: explainChunkSimilarity(sourceText, chunk.text, chunk.filePath === filePath, chunk.score),
            }));
    ...
    router.post('/chunks/batch-related', asyncHandler(async (req, res) => {
